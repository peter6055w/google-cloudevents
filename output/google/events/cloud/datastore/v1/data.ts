...
export interface EntityEventData {
   ...
   */
  updateMask?: PropertyMask | undefined;
}
...
function createBaseEntityEventData(): EntityEventData {
  return { value: undefined, oldValue: undefined, updateMask: undefined };
}

export const EntityEventData: MessageFns<EntityEventData> = {
  encode(message: EntityEventData, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.value !== undefined) {
      EntityResult.encode(message.value, writer.uint32(10).fork()).join();
    }
    if (message.oldValue !== undefined) {
      EntityResult.encode(message.oldValue, writer.uint32(18).fork()).join();
    }
    if (message.updateMask !== undefined) {
      PropertyMask.encode(message.updateMask, writer.uint32(26).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): EntityEventData {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseEntityEventData();
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1: {
          ...
          message.value = EntityResult.decode(reader, reader.uint32());
          continue;
        }
        case 2: {
          if (tag !== 18) {
          ...
          message.oldValue = EntityResult.decode(reader, reader.uint32());
          continue;
        }
        case 3: {
          if (tag !== 26) {
          ...
          message.updateMask = PropertyMask.decode(reader, reader.uint32());
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): EntityEventData {
    return {
      value: isSet(object.value) ? EntityResult.fromJSON(object.value) : undefined,
      oldValue: isSet(object.oldValue) ? EntityResult.fromJSON(object.oldValue) : undefined,
      updateMask: isSet(object.updateMask) ? PropertyMask.fromJSON(object.updateMask) : undefined,
    };
  },

  toJSON(message: EntityEventData): unknown {
    const obj: any = {};
    if (message.value !== undefined) {
      obj.value = EntityResult.toJSON(message.value);
    }
    if (message.oldValue !== undefined) {
      obj.oldValue = EntityResult.toJSON(message.oldValue);
    }
    if (message.updateMask !== undefined) {
      obj.updateMask = PropertyMask.toJSON(message.updateMask);
    }
    return obj;
  },

  create<I extends Exact<DeepPartial<EntityEventData>, I>>(base?: I): EntityEventData {
    return EntityEventData.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<EntityEventData>, I>>(object: I): EntityEventData {
    const message = createBaseEntityEventData();
    message.value = (object.value !== undefined && object.value !== null)
      ? EntityResult.fromPartial(object.value)
      : undefined;
    message.oldValue = (object.oldValue !== undefined && object.oldValue !== null)
      ? EntityResult.fromPartial(object.oldValue)
      : undefined;
    message.updateMask = (object.updateMask !== undefined && object.updateMask !== null)
      ? PropertyMask.fromPartial(object.updateMask)
      : undefined;
    return message;
  },
};
...
export const PropertyMask: MessageFns<PropertyMask> = {
  encode(message: PropertyMask, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.propertyPaths) {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1: {
          ...
          message.propertyPaths.push(reader.string());
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): PropertyMask {
    return {
      propertyPaths: globalThis.Array.isArray(object?.propertyPaths)
        ? object.propertyPaths.map((e: any) => globalThis.String(e))
        : [],
    };
  },
  ...
  toJSON(message: PropertyMask): unknown {
    const obj: any = {};
    if (message.propertyPaths?.length) {
      obj.propertyPaths = message.propertyPaths;
    }
    return obj;
  },

  create<I extends Exact<DeepPartial<PropertyMask>, I>>(base?: I): PropertyMask {
    return PropertyMask.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<PropertyMask>, I>>(object: I): PropertyMask {
    const message = createBasePropertyMask();
    message.propertyPaths = object.propertyPaths?.map((e) => e) || [];
    return message;
  },
};
...
export const EntityResult: MessageFns<EntityResult> = {
  ...
  create<I extends Exact<DeepPartial<EntityResult>, I>>(base?: I): EntityResult {
    return EntityResult.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<EntityResult>, I>>(object: I): EntityResult {
    const message = createBaseEntityResult();
...
function createBasePartitionId(): PartitionId {
  return { projectId: "", databaseId: "", namespaceId: "" };
}
...
export const PartitionId: MessageFns<PartitionId> = {
  ...
  create<I extends Exact<DeepPartial<PartitionId>, I>>(base?: I): PartitionId {
    return PartitionId.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<PartitionId>, I>>(object: I): PartitionId {
    const message = createBasePartitionId();
...
export const Key_PathElement: MessageFns<Key_PathElement> = {
  ...
  create<I extends Exact<DeepPartial<Key_PathElement>, I>>(base?: I): Key_PathElement {
    return Key_PathElement.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<Key_PathElement>, I>>(object: I): Key_PathElement {
    const message = createBaseKey_PathElement();
...
export const Value: MessageFns<Value> = {
  ...
  fromJSON(object: any): Value {
    return {
      ...
      blobValue: isSet(object.blobValue) ? bytesFromBase64(object.blobValue) : undefined,
...
export const Entity_PropertiesEntry: MessageFns<Entity_PropertiesEntry> = {
  ...
  create<I extends Exact<DeepPartial<Entity_PropertiesEntry>, I>>(base?: I): Entity_PropertiesEntry {
    return Entity_PropertiesEntry.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<Entity_PropertiesEntry>, I>>(object: I): Entity_PropertiesEntry {
    const message = createBaseEntity_PropertiesEntry();
