...
export interface PrivateConnectionEventData {
  /** Optional. The PrivateConnection event payload. Unset for deletion events. */
  payload?: PrivateConnection | undefined;
}
...
function createBaseOracleProfile(): OracleProfile {
  return { hostname: "", port: 0, username: "", databaseService: "", connectionAttributes: {} };
}
...
export const OracleProfile: MessageFns<OracleProfile> = {
  ...
  create<I extends Exact<DeepPartial<OracleProfile>, I>>(base?: I): OracleProfile {
    return OracleProfile.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<OracleProfile>, I>>(object: I): OracleProfile {
    const message = createBaseOracleProfile();
...
export const OracleProfile_ConnectionAttributesEntry: MessageFns<OracleProfile_ConnectionAttributesEntry> = {
  ...
  create<I extends Exact<DeepPartial<OracleProfile_ConnectionAttributesEntry>, I>>(
    base?: I,
  ): OracleProfile_ConnectionAttributesEntry {
    return OracleProfile_ConnectionAttributesEntry.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<OracleProfile_ConnectionAttributesEntry>, I>>(
    object: I,
  ): OracleProfile_ConnectionAttributesEntry {
    const message = createBaseOracleProfile_ConnectionAttributesEntry();
...
function createBaseMysqlProfile(): MysqlProfile {
  return { hostname: "", port: 0, username: "", sslConfig: undefined };
}
...
export const MysqlProfile: MessageFns<MysqlProfile> = {
  ...
  create<I extends Exact<DeepPartial<MysqlProfile>, I>>(base?: I): MysqlProfile {
    return MysqlProfile.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<MysqlProfile>, I>>(object: I): MysqlProfile {
    const message = createBaseMysqlProfile();
    message.hostname = object.hostname ?? "";
    message.port = object.port ?? 0;
    message.username = object.username ?? "";
...
function createBasePostgresqlProfile(): PostgresqlProfile {
  return { hostname: "", port: 0, username: "", database: "" };
}
...
export const PostgresqlProfile: MessageFns<PostgresqlProfile> = {
  ...
  create<I extends Exact<DeepPartial<PostgresqlProfile>, I>>(base?: I): PostgresqlProfile {
    return PostgresqlProfile.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<PostgresqlProfile>, I>>(object: I): PostgresqlProfile {
    const message = createBasePostgresqlProfile();
    message.hostname = object.hostname ?? "";
    message.port = object.port ?? 0;
    message.username = object.username ?? "";
...
export const GcsProfile: MessageFns<GcsProfile> = {
  ...
  create<I extends Exact<DeepPartial<GcsProfile>, I>>(base?: I): GcsProfile {
    return GcsProfile.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<GcsProfile>, I>>(object: I): GcsProfile {
    const message = createBaseGcsProfile();
...
export const BigQueryProfile: MessageFns<BigQueryProfile> = {
  ...
  create<I extends Exact<DeepPartial<BigQueryProfile>, I>>(base?: I): BigQueryProfile {
    return BigQueryProfile.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<BigQueryProfile>, I>>(_: I): BigQueryProfile {
    const message = createBaseBigQueryProfile();
    return message;
  },
};
...
export const StaticServiceIpConnectivity: MessageFns<StaticServiceIpConnectivity> = {
  ...
  create<I extends Exact<DeepPartial<StaticServiceIpConnectivity>, I>>(base?: I): StaticServiceIpConnectivity {
    return StaticServiceIpConnectivity.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<StaticServiceIpConnectivity>, I>>(_: I): StaticServiceIpConnectivity {
    const message = createBaseStaticServiceIpConnectivity();
    return message;
  },
};
...
function createBaseForwardSshTunnelConnectivity(): ForwardSshTunnelConnectivity {
  return { hostname: "", username: "", port: 0 };
}
...
export const ForwardSshTunnelConnectivity: MessageFns<ForwardSshTunnelConnectivity> = {
  ...
  create<I extends Exact<DeepPartial<ForwardSshTunnelConnectivity>, I>>(base?: I): ForwardSshTunnelConnectivity {
    return ForwardSshTunnelConnectivity.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<ForwardSshTunnelConnectivity>, I>>(object: I): ForwardSshTunnelConnectivity {
    const message = createBaseForwardSshTunnelConnectivity();
    message.hostname = object.hostname ?? "";
    message.username = object.username ?? "";
    message.port = object.port ?? 0;
...
export const VpcPeeringConfig: MessageFns<VpcPeeringConfig> = {
  ...
  create<I extends Exact<DeepPartial<VpcPeeringConfig>, I>>(base?: I): VpcPeeringConfig {
    return VpcPeeringConfig.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<VpcPeeringConfig>, I>>(object: I): VpcPeeringConfig {
    const message = createBaseVpcPeeringConfig();
...
export const PrivateConnection: MessageFns<PrivateConnection> = {
  ...
  create<I extends Exact<DeepPartial<PrivateConnection>, I>>(base?: I): PrivateConnection {
    return PrivateConnection.fromPartial(base ?? ({} as any));
  },
...
export const PrivateConnection_LabelsEntry: MessageFns<PrivateConnection_LabelsEntry> = {
  ...
  create<I extends Exact<DeepPartial<PrivateConnection_LabelsEntry>, I>>(base?: I): PrivateConnection_LabelsEntry {
    return PrivateConnection_LabelsEntry.fromPartial(base ?? ({} as any));
  },
...
export const PrivateConnectivity: MessageFns<PrivateConnectivity> = {
  ...
  create<I extends Exact<DeepPartial<PrivateConnectivity>, I>>(base?: I): PrivateConnectivity {
    return PrivateConnectivity.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<PrivateConnectivity>, I>>(object: I): PrivateConnectivity {
    const message = createBasePrivateConnectivity();
...
export const Route_LabelsEntry: MessageFns<Route_LabelsEntry> = {
  ...
  create<I extends Exact<DeepPartial<Route_LabelsEntry>, I>>(base?: I): Route_LabelsEntry {
    return Route_LabelsEntry.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<Route_LabelsEntry>, I>>(object: I): Route_LabelsEntry {
    const message = createBaseRoute_LabelsEntry();
    message.key = object.key ?? "";
    message.value = object.value ?? "";
    return message;
...
function createBaseMysqlSslConfig(): MysqlSslConfig {
  return { clientKeySet: false, clientCertificateSet: false, caCertificateSet: false };
}
...
export const MysqlSslConfig: MessageFns<MysqlSslConfig> = {
  ...
  create<I extends Exact<DeepPartial<MysqlSslConfig>, I>>(base?: I): MysqlSslConfig {
    return MysqlSslConfig.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<MysqlSslConfig>, I>>(object: I): MysqlSslConfig {
    const message = createBaseMysqlSslConfig();
...
export const OracleColumn: MessageFns<OracleColumn> = {
  ...
  create<I extends Exact<DeepPartial<OracleColumn>, I>>(base?: I): OracleColumn {
    return OracleColumn.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<OracleColumn>, I>>(object: I): OracleColumn {
    const message = createBaseOracleColumn();
...
export const OracleTable: MessageFns<OracleTable> = {
  ...
  create<I extends Exact<DeepPartial<OracleTable>, I>>(base?: I): OracleTable {
    return OracleTable.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<OracleTable>, I>>(object: I): OracleTable {
    const message = createBaseOracleTable();
...
export const OracleSchema: MessageFns<OracleSchema> = {
  ...
  create<I extends Exact<DeepPartial<OracleSchema>, I>>(base?: I): OracleSchema {
    return OracleSchema.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<OracleSchema>, I>>(object: I): OracleSchema {
    const message = createBaseOracleSchema();
...
export const OracleRdbms: MessageFns<OracleRdbms> = {
  ...
  create<I extends Exact<DeepPartial<OracleRdbms>, I>>(base?: I): OracleRdbms {
    return OracleRdbms.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<OracleRdbms>, I>>(object: I): OracleRdbms {
    const message = createBaseOracleRdbms();
...
export const OracleSourceConfig: MessageFns<OracleSourceConfig> = {
  ...
  create<I extends Exact<DeepPartial<OracleSourceConfig>, I>>(base?: I): OracleSourceConfig {
    return OracleSourceConfig.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<OracleSourceConfig>, I>>(object: I): OracleSourceConfig {
    const message = createBaseOracleSourceConfig();
...
export const OracleSourceConfig_DropLargeObjects: MessageFns<OracleSourceConfig_DropLargeObjects> = {
  ...
  create<I extends Exact<DeepPartial<OracleSourceConfig_DropLargeObjects>, I>>(
    base?: I,
  ): OracleSourceConfig_DropLargeObjects {
    return OracleSourceConfig_DropLargeObjects.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<OracleSourceConfig_DropLargeObjects>, I>>(
    _: I,
  ): OracleSourceConfig_DropLargeObjects {
    const message = createBaseOracleSourceConfig_DropLargeObjects();
    return message;
...
export const OracleSourceConfig_StreamLargeObjects: MessageFns<OracleSourceConfig_StreamLargeObjects> = {
  ...
  create<I extends Exact<DeepPartial<OracleSourceConfig_StreamLargeObjects>, I>>(
    base?: I,
  ): OracleSourceConfig_StreamLargeObjects {
    return OracleSourceConfig_StreamLargeObjects.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<OracleSourceConfig_StreamLargeObjects>, I>>(
    _: I,
  ): OracleSourceConfig_StreamLargeObjects {
    const message = createBaseOracleSourceConfig_StreamLargeObjects();
    return message;
...
export const PostgresqlColumn: MessageFns<PostgresqlColumn> = {
  ...
  create<I extends Exact<DeepPartial<PostgresqlColumn>, I>>(base?: I): PostgresqlColumn {
    return PostgresqlColumn.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<PostgresqlColumn>, I>>(object: I): PostgresqlColumn {
    const message = createBasePostgresqlColumn();
    message.column = object.column ?? "";
    message.dataType = object.dataType ?? "";
    message.length = object.length ?? 0;
...
export const PostgresqlTable: MessageFns<PostgresqlTable> = {
  ...
  create<I extends Exact<DeepPartial<PostgresqlTable>, I>>(base?: I): PostgresqlTable {
    return PostgresqlTable.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<PostgresqlTable>, I>>(object: I): PostgresqlTable {
    const message = createBasePostgresqlTable();
    message.table = object.table ?? "";
...
export const PostgresqlSchema: MessageFns<PostgresqlSchema> = {
  ...
  create<I extends Exact<DeepPartial<PostgresqlSchema>, I>>(base?: I): PostgresqlSchema {
    return PostgresqlSchema.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<PostgresqlSchema>, I>>(object: I): PostgresqlSchema {
    const message = createBasePostgresqlSchema();
    message.schema = object.schema ?? "";
...
export const PostgresqlRdbms: MessageFns<PostgresqlRdbms> = {
  ...
  create<I extends Exact<DeepPartial<PostgresqlRdbms>, I>>(base?: I): PostgresqlRdbms {
    return PostgresqlRdbms.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<PostgresqlRdbms>, I>>(object: I): PostgresqlRdbms {
    const message = createBasePostgresqlRdbms();
...
function createBasePostgresqlSourceConfig(): PostgresqlSourceConfig {
  return { includeObjects: undefined, excludeObjects: undefined, replicationSlot: "", publication: "" };
}
...
export const PostgresqlSourceConfig: MessageFns<PostgresqlSourceConfig> = {
  ...
  create<I extends Exact<DeepPartial<PostgresqlSourceConfig>, I>>(base?: I): PostgresqlSourceConfig {
    return PostgresqlSourceConfig.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<PostgresqlSourceConfig>, I>>(object: I): PostgresqlSourceConfig {
    const message = createBasePostgresqlSourceConfig();
    message.includeObjects = (object.includeObjects !== undefined && object.includeObjects !== null)
...
function createBaseMysqlColumn(): MysqlColumn {
  return { column: "", dataType: "", length: 0, collation: "", primaryKey: false, nullable: false, ordinalPosition: 0 };
}
...
export const MysqlColumn: MessageFns<MysqlColumn> = {
  ...
  create<I extends Exact<DeepPartial<MysqlColumn>, I>>(base?: I): MysqlColumn {
    return MysqlColumn.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<MysqlColumn>, I>>(object: I): MysqlColumn {
    const message = createBaseMysqlColumn();
    message.column = object.column ?? "";
    message.dataType = object.dataType ?? "";
    message.length = object.length ?? 0;
...
export const MysqlTable: MessageFns<MysqlTable> = {
  ...
  create<I extends Exact<DeepPartial<MysqlTable>, I>>(base?: I): MysqlTable {
    return MysqlTable.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<MysqlTable>, I>>(object: I): MysqlTable {
    const message = createBaseMysqlTable();
    message.table = object.table ?? "";
...
export const MysqlDatabase: MessageFns<MysqlDatabase> = {
  ...
  create<I extends Exact<DeepPartial<MysqlDatabase>, I>>(base?: I): MysqlDatabase {
    return MysqlDatabase.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<MysqlDatabase>, I>>(object: I): MysqlDatabase {
    const message = createBaseMysqlDatabase();
    message.database = object.database ?? "";
...
export const MysqlRdbms: MessageFns<MysqlRdbms> = {
  ...
  create<I extends Exact<DeepPartial<MysqlRdbms>, I>>(base?: I): MysqlRdbms {
    return MysqlRdbms.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<MysqlRdbms>, I>>(object: I): MysqlRdbms {
    const message = createBaseMysqlRdbms();
...
function createBaseMysqlSourceConfig(): MysqlSourceConfig {
  return { includeObjects: undefined, excludeObjects: undefined, maxConcurrentCdcTasks: 0 };
}
...
export const MysqlSourceConfig: MessageFns<MysqlSourceConfig> = {
  ...
  create<I extends Exact<DeepPartial<MysqlSourceConfig>, I>>(base?: I): MysqlSourceConfig {
    return MysqlSourceConfig.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<MysqlSourceConfig>, I>>(object: I): MysqlSourceConfig {
    const message = createBaseMysqlSourceConfig();
    message.includeObjects = (object.includeObjects !== undefined && object.includeObjects !== null)
...
export const SourceConfig: MessageFns<SourceConfig> = {
  ...
  create<I extends Exact<DeepPartial<SourceConfig>, I>>(base?: I): SourceConfig {
    return SourceConfig.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<SourceConfig>, I>>(object: I): SourceConfig {
    const message = createBaseSourceConfig();
...
export const AvroFileFormat: MessageFns<AvroFileFormat> = {
  ...
  create<I extends Exact<DeepPartial<AvroFileFormat>, I>>(base?: I): AvroFileFormat {
    return AvroFileFormat.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<AvroFileFormat>, I>>(_: I): AvroFileFormat {
    const message = createBaseAvroFileFormat();
    return message;
  },
};
...
export const JsonFileFormat: MessageFns<JsonFileFormat> = {
  ...
  create<I extends Exact<DeepPartial<JsonFileFormat>, I>>(base?: I): JsonFileFormat {
    return JsonFileFormat.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<JsonFileFormat>, I>>(object: I): JsonFileFormat {
    const message = createBaseJsonFileFormat();
...
export const GcsDestinationConfig: MessageFns<GcsDestinationConfig> = {
  ...
  create<I extends Exact<DeepPartial<GcsDestinationConfig>, I>>(base?: I): GcsDestinationConfig {
    return GcsDestinationConfig.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<GcsDestinationConfig>, I>>(object: I): GcsDestinationConfig {
    const message = createBaseGcsDestinationConfig();
...
export const BigQueryDestinationConfig: MessageFns<BigQueryDestinationConfig> = {
  ...
  create<I extends Exact<DeepPartial<BigQueryDestinationConfig>, I>>(base?: I): BigQueryDestinationConfig {
    return BigQueryDestinationConfig.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<BigQueryDestinationConfig>, I>>(object: I): BigQueryDestinationConfig {
    const message = createBaseBigQueryDestinationConfig();
...
export const BigQueryDestinationConfig_SingleTargetDataset: MessageFns<BigQueryDestinationConfig_SingleTargetDataset> =
  {
    ...
    create<I extends Exact<DeepPartial<BigQueryDestinationConfig_SingleTargetDataset>, I>>(
      base?: I,
    ): BigQueryDestinationConfig_SingleTargetDataset {
      return BigQueryDestinationConfig_SingleTargetDataset.fromPartial(base ?? ({} as any));
    },
    fromPartial<I extends Exact<DeepPartial<BigQueryDestinationConfig_SingleTargetDataset>, I>>(
      object: I,
    ): BigQueryDestinationConfig_SingleTargetDataset {
      const message = createBaseBigQueryDestinationConfig_SingleTargetDataset();
...
> = {
  ...
  create<I extends Exact<DeepPartial<BigQueryDestinationConfig_SourceHierarchyDatasets>, I>>(
    base?: I,
  ): BigQueryDestinationConfig_SourceHierarchyDatasets {
    return BigQueryDestinationConfig_SourceHierarchyDatasets.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<BigQueryDestinationConfig_SourceHierarchyDatasets>, I>>(
    object: I,
  ): BigQueryDestinationConfig_SourceHierarchyDatasets {
    const message = createBaseBigQueryDestinationConfig_SourceHierarchyDatasets();
...
> = {
  ...
  create<I extends Exact<DeepPartial<BigQueryDestinationConfig_SourceHierarchyDatasets_DatasetTemplate>, I>>(
    base?: I,
  ): BigQueryDestinationConfig_SourceHierarchyDatasets_DatasetTemplate {
    return BigQueryDestinationConfig_SourceHierarchyDatasets_DatasetTemplate.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<BigQueryDestinationConfig_SourceHierarchyDatasets_DatasetTemplate>, I>>(
    object: I,
  ): BigQueryDestinationConfig_SourceHierarchyDatasets_DatasetTemplate {
    const message = createBaseBigQueryDestinationConfig_SourceHierarchyDatasets_DatasetTemplate();
...
export const DestinationConfig: MessageFns<DestinationConfig> = {
  ...
  create<I extends Exact<DeepPartial<DestinationConfig>, I>>(base?: I): DestinationConfig {
    return DestinationConfig.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<DestinationConfig>, I>>(object: I): DestinationConfig {
    const message = createBaseDestinationConfig();
...
export const Stream_BackfillAllStrategy: MessageFns<Stream_BackfillAllStrategy> = {
  ...
  create<I extends Exact<DeepPartial<Stream_BackfillAllStrategy>, I>>(base?: I): Stream_BackfillAllStrategy {
    return Stream_BackfillAllStrategy.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<Stream_BackfillAllStrategy>, I>>(object: I): Stream_BackfillAllStrategy {
    const message = createBaseStream_BackfillAllStrategy();
...
export const Stream_BackfillNoneStrategy: MessageFns<Stream_BackfillNoneStrategy> = {
  ...
  create<I extends Exact<DeepPartial<Stream_BackfillNoneStrategy>, I>>(base?: I): Stream_BackfillNoneStrategy {
    return Stream_BackfillNoneStrategy.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<Stream_BackfillNoneStrategy>, I>>(_: I): Stream_BackfillNoneStrategy {
    const message = createBaseStream_BackfillNoneStrategy();
    return message;
  },
};
...
function createBasePrivateConnectionEventData(): PrivateConnectionEventData {
  return { payload: undefined };
}

export const PrivateConnectionEventData: MessageFns<PrivateConnectionEventData> = {
  encode(message: PrivateConnectionEventData, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.payload !== undefined) {
      PrivateConnection.encode(message.payload, writer.uint32(10).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): PrivateConnectionEventData {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBasePrivateConnectionEventData();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
          ...
          message.payload = PrivateConnection.decode(reader, reader.uint32());
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): PrivateConnectionEventData {
    return { payload: isSet(object.payload) ? PrivateConnection.fromJSON(object.payload) : undefined };
  },

  toJSON(message: PrivateConnectionEventData): unknown {
    const obj: any = {};
    if (message.payload !== undefined) {
      obj.payload = PrivateConnection.toJSON(message.payload);
    }
    return obj;
  },

  create<I extends Exact<DeepPartial<PrivateConnectionEventData>, I>>(base?: I): PrivateConnectionEventData {
    return PrivateConnectionEventData.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<PrivateConnectionEventData>, I>>(object: I): PrivateConnectionEventData {
    const message = createBasePrivateConnectionEventData();
    message.payload = (object.payload !== undefined && object.payload !== null)
      ? PrivateConnection.fromPartial(object.payload)
      : undefined;
    return message;
  },
};
...
function createBaseRouteEventData(): RouteEventData {
  return { payload: undefined };
}

export const RouteEventData: MessageFns<RouteEventData> = {
  encode(message: RouteEventData, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.payload !== undefined) {
      Route.encode(message.payload, writer.uint32(10).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): RouteEventData {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseRouteEventData();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
          ...
          message.payload = Route.decode(reader, reader.uint32());
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): RouteEventData {
    return { payload: isSet(object.payload) ? Route.fromJSON(object.payload) : undefined };
  },

  toJSON(message: RouteEventData): unknown {
    const obj: any = {};
    if (message.payload !== undefined) {
      obj.payload = Route.toJSON(message.payload);
    }
    return obj;
  },

  create<I extends Exact<DeepPartial<RouteEventData>, I>>(base?: I): RouteEventData {
    return RouteEventData.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<RouteEventData>, I>>(object: I): RouteEventData {
    const message = createBaseRouteEventData();
    message.payload = (object.payload !== undefined && object.payload !== null)
      ? Route.fromPartial(object.payload)
      : undefined;
    return message;
  },
};
