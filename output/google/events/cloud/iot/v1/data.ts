...
export interface RegistryEventData {
  ...
  payload?: DeviceRegistry | undefined;
}
...
export const DeviceRegistry: MessageFns<DeviceRegistry> = {
  ...
  create<I extends Exact<DeepPartial<DeviceRegistry>, I>>(base?: I): DeviceRegistry {
    return DeviceRegistry.fromPartial(base ?? ({} as any));
  },
...
export const MqttConfig: MessageFns<MqttConfig> = {
  ...
  create<I extends Exact<DeepPartial<MqttConfig>, I>>(base?: I): MqttConfig {
    return MqttConfig.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<MqttConfig>, I>>(object: I): MqttConfig {
    const message = createBaseMqttConfig();
...
export const EventNotificationConfig: MessageFns<EventNotificationConfig> = {
  ...
  create<I extends Exact<DeepPartial<EventNotificationConfig>, I>>(base?: I): EventNotificationConfig {
    return EventNotificationConfig.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<EventNotificationConfig>, I>>(object: I): EventNotificationConfig {
    const message = createBaseEventNotificationConfig();
...
export const StateNotificationConfig: MessageFns<StateNotificationConfig> = {
  ...
  create<I extends Exact<DeepPartial<StateNotificationConfig>, I>>(base?: I): StateNotificationConfig {
    return StateNotificationConfig.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<StateNotificationConfig>, I>>(object: I): StateNotificationConfig {
    const message = createBaseStateNotificationConfig();
    message.pubsubTopicName = object.pubsubTopicName ?? "";
    return message;
  },
...
export const RegistryCredential: MessageFns<RegistryCredential> = {
  ...
  create<I extends Exact<DeepPartial<RegistryCredential>, I>>(base?: I): RegistryCredential {
    return RegistryCredential.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<RegistryCredential>, I>>(object: I): RegistryCredential {
    const message = createBaseRegistryCredential();
...
export const X509CertificateDetails: MessageFns<X509CertificateDetails> = {
  ...
  create<I extends Exact<DeepPartial<X509CertificateDetails>, I>>(base?: I): X509CertificateDetails {
    return X509CertificateDetails.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<X509CertificateDetails>, I>>(object: I): X509CertificateDetails {
    const message = createBaseX509CertificateDetails();
...
export const PublicKeyCertificate: MessageFns<PublicKeyCertificate> = {
  ...
  create<I extends Exact<DeepPartial<PublicKeyCertificate>, I>>(base?: I): PublicKeyCertificate {
    return PublicKeyCertificate.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<PublicKeyCertificate>, I>>(object: I): PublicKeyCertificate {
    const message = createBasePublicKeyCertificate();
...
export const DeviceCredential: MessageFns<DeviceCredential> = {
  ...
  create<I extends Exact<DeepPartial<DeviceCredential>, I>>(base?: I): DeviceCredential {
    return DeviceCredential.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<DeviceCredential>, I>>(object: I): DeviceCredential {
    const message = createBaseDeviceCredential();
...
export const PublicKeyCredential: MessageFns<PublicKeyCredential> = {
  ...
  create<I extends Exact<DeepPartial<PublicKeyCredential>, I>>(base?: I): PublicKeyCredential {
    return PublicKeyCredential.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<PublicKeyCredential>, I>>(object: I): PublicKeyCredential {
    const message = createBasePublicKeyCredential();
    message.format = object.format ?? 0;
    message.key = object.key ?? "";
    return message;
...
function createBaseDeviceConfig(): DeviceConfig {
  return { version: Long.ZERO, cloudUpdateTime: undefined, deviceAckTime: undefined, binaryData: new Uint8Array(0) };
}
...
function createBaseDeviceState(): DeviceState {
  return { updateTime: undefined, binaryData: new Uint8Array(0) };
}
...
function createBaseDeviceEventData(): DeviceEventData {
  return { payload: undefined };
}

export const DeviceEventData: MessageFns<DeviceEventData> = {
  encode(message: DeviceEventData, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.payload !== undefined) {
      Device.encode(message.payload, writer.uint32(10).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): DeviceEventData {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseDeviceEventData();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
          ...
          message.payload = Device.decode(reader, reader.uint32());
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): DeviceEventData {
    return { payload: isSet(object.payload) ? Device.fromJSON(object.payload) : undefined };
  },

  toJSON(message: DeviceEventData): unknown {
    const obj: any = {};
    if (message.payload !== undefined) {
      obj.payload = Device.toJSON(message.payload);
    }
    return obj;
  },

  create<I extends Exact<DeepPartial<DeviceEventData>, I>>(base?: I): DeviceEventData {
    return DeviceEventData.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<DeviceEventData>, I>>(object: I): DeviceEventData {
    const message = createBaseDeviceEventData();
    message.payload = (object.payload !== undefined && object.payload !== null)
      ? Device.fromPartial(object.payload)
      : undefined;
    return message;
  },
};

function createBaseRegistryEventData(): RegistryEventData {
  return { payload: undefined };
}

export const RegistryEventData: MessageFns<RegistryEventData> = {
  encode(message: RegistryEventData, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.payload !== undefined) {
      DeviceRegistry.encode(message.payload, writer.uint32(10).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): RegistryEventData {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseRegistryEventData();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
          ...
          message.payload = DeviceRegistry.decode(reader, reader.uint32());
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): RegistryEventData {
    return { payload: isSet(object.payload) ? DeviceRegistry.fromJSON(object.payload) : undefined };
  },

  toJSON(message: RegistryEventData): unknown {
    const obj: any = {};
    if (message.payload !== undefined) {
      obj.payload = DeviceRegistry.toJSON(message.payload);
    }
    return obj;
  },

  create<I extends Exact<DeepPartial<RegistryEventData>, I>>(base?: I): RegistryEventData {
    return RegistryEventData.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<RegistryEventData>, I>>(object: I): RegistryEventData {
    const message = createBaseRegistryEventData();
    message.payload = (object.payload !== undefined && object.payload !== null)
      ? DeviceRegistry.fromPartial(object.payload)
      : undefined;
    return message;
  },
};
