...
export const AuthEventData: MessageFns<AuthEventData> = {
  encode(message: AuthEventData, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.value !== undefined) {
      User.encode(message.value, writer.uint32(10).fork()).join();
    }
    if (message.oldValue !== undefined) {
      User.encode(message.oldValue, writer.uint32(18).fork()).join();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2: {
          ...
          message.oldValue = User.decode(reader, reader.uint32());
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): AuthEventData {
    return {
      ...
      oldValue: isSet(object.oldValue) ? User.fromJSON(object.oldValue) : undefined,
    };
  },
  ...
  toJSON(message: AuthEventData): unknown {
    ...
    if (message.oldValue !== undefined) {
      obj.oldValue = User.toJSON(message.oldValue);
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<AuthEventData>, I>>(object: I): AuthEventData {
    ...
    message.oldValue = (object.oldValue !== undefined && object.oldValue !== null)
      ? User.fromPartial(object.oldValue)
      : undefined;
    return message;
  },
};
